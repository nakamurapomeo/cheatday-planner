...
export default function Layout({
    ...
    return (
        <div
            className="flex h-screen w-full bg-slate-100 overflow-hidden justify-center" // Background slightly darker, center content is white/slate-50
            onTouchStart={onTouchStart}
            onTouchMove={onTouchMove}
            onTouchEnd={onTouchEnd}
        >
            <div className="flex w-full max-w-[1280px] h-full bg-white shadow-2xl overflow-hidden relative">
